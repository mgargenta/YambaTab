...
public class StatusData {
  ...
  public static final String C_PROFILE_IMAGE_URL = "profile_image_url";
  ...
  class DbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
      ...
      db.execSQL("create table " + TABLE + " (" + C_ID + " int primary key, "
          + C_CREATED_AT + " int, " + C_USER + " text, " + C_SCREEN_NAME
          + " text, " + C_PROFILE_IMAGE_URL + " text, " + C_TEXT + " text)");
    }
  ...
  public long getLatestStatusCreatedAtTime() {
    ...
    try {
      ...
      try {
        ...
        Log.e(TAG, "Error in getLatestStatusCreatedAtTime", e);
        return -1;
      }
  ...
  public String getStatusTextById(long id) {
    ...
    try {
      ...
      try {
        ...
        Log.e(TAG, "Error in getStatusTextById", e);
        return "";
      } 
//      finally {
//        cursor.close();
